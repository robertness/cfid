...
edgestring <- get_edgestring(g_)
dagitty_g <- dagitty::dagitty(paste("dag {", edgestring, "}"))
ggdag::ggdag(dagitty_g) + ggdag::theme_dag_gray()
```

Plotting with bnlearn and Rgraphviz.  Rgraphviz needs to be installed via bioconductor.
